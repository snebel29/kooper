...
import (
	v1alpha1 "github.com/snebel29/kooper/examples/pod-terminator-operator/apis/chaos/v1alpha1"
	scheme "github.com/snebel29/kooper/examples/pod-terminator-operator/client/k8s/clientset/versioned/scheme"
