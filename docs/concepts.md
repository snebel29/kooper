...
In this framework it is defined as an interface [here](https://github.com/snebel29/kooper/tree/master/operator/controller)
...
so we can know the kind of the Retriever by inspecting the object. It is defined [here](https://github.com/snebel29/kooper/tree/master/operator/retrieve)
